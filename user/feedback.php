...
if(isset($_POST["submit"]))
{
  ...
  $exe = $con->query("insert into feedback(Customer_id,Message,Date,Rating) values('$id','$message','$date','$rate')");
...
// $res = $con->query("select * from company");
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="#" method="post" class="p-5 bg-white rounded Regular shadow">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Send" class="btn btn-primary  py-2 px-4" style="border-radius: 15px;">
                </div>
              </div>
