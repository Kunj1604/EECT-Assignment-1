...
<!-- 
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <input type="hidden" name="item_number" value="<?php echo  $_SESSION["totalqua"]; ?>">
        <input type="hidden" name="amount" value="<?php echo $_SESSION["fororder"]; ?>">
        ...
        src="images/buy.png" height="300px" width="800px" alt="PayPal - The safer, easier way to pay online">
