...
if (isset($_POST['submit'])) {
  ...
  if (empty($_POST["email"])) {
    $error = "<p style='color:red;font-size:10;margin:0px;margin-left:0px;'>*Email is required</p>";
  } else {
    $email = test_input($_POST["email"]);
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
      $error = "<p style='color:red;font-size:10;margin:0px;margin-left:0px'>Invalid email format</p>";
    }
  }
  if (empty($password)) {
    $error1 = "<p style='color:red;font-size:10;margin:0px;margin-left:0px'>*Please Check your password</p>";
  } else {
      ...
      <div class="container">
        ...
        <div class="col-md-12 col-lg-2 mb-5"></div>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form method="post"  action="#" class="p-5 bg-white Larger shadow" style="border-radius: 10px !important;" novalidate>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Login" name="submit" class="btn btn-danger  py-2 px-4">
                </div>
              </div>
