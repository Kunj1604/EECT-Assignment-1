...
<div class="container py-3">
    <div class="d-flex justify-content-between mb-2">
        <h3>Cart</h3>
        <a class="btn btn-danger" href="candy.php?action=empty">All Item Remove</a>
                ...
                foreach ($_SESSION['cart_item'] as $item) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="candy.php?action=remove&Menu_id=<?= $item['Menu_id']; ?>" class="btn btn-danger">X</a>
                        </td>
                    </tr>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex">
                <div class="card-deck">
                    <?php
                    $query = "select * from add_menu where Category='Candy'";
                    $product = mysqli_query($con, $query);
                    if (!empty($product)) {
                        while ($row = mysqli_fetch_array($product)) { ?>
                            <form action="candy.php?action=add&pid=<?= $row['Menu_id']; ?>" method="post">
