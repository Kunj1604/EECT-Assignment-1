...
if(isset($_POST['submit']))
{
    ...
    $mail->Username   = 'mehtaalpha2@gmail.com';                     //SMTP username
    $mail->Password   = '9157472229';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('mehtaalpha2@gmail.com', 'Only Dhosa Password');
      ...
      <div class="container">
        ...
        <div class="col-md-12 col-lg-2 mb-5"></div>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form method="post"  action="#" class="p-5 bg-white Larger shadow rounded">

              
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="email">Enter Your Email Address</label>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Submit" name="submit" class="btn btn-primary  py-2 px-4" style="border-radius: 15px;">
                </div>
              </div>
